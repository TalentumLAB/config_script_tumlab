...
path_xml="/root/.config/syncthing/config.xml"
name_label=$(hostname)
...
if [[ $exist_xml_file == 'true' ]]; then
    sudo rm -r /root/.config/syncthing
...
echo "Digite el numero del municipio. Balboa=1, Miranda=2, Cajibio=3, B/Aires=4, sipi=5, patia=6, p/leguizamo=7, valle=8, quindio=9 "
read -r id_municipio
...
8)
    ...
    ;;
9)
    id_server="ZKILJ7P-YI7QCMG-6JPZHHU-JLHB6EY-AB5XXHA-LTSGLXM-53W5QWF-3OPEUAJ"
    ;;
*)
